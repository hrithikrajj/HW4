...
//    }
    ...
    if(utype=="student")
    {
        query.prepare("select * from student_credentials where username='"+uname+"' and password='"+tmppasswd+"'");
    }
    else if(utype=="faculty")
    {
        query.prepare("select * from faculty_credentials where username='"+uname+"' and password='"+tmppasswd+"'");
    }
    else if(utype=="academics")
    {
        query.prepare("select * from acad_credentials where username='"+uname+"' and password='"+tmppasswd+"'");
    }
    if(query.exec())
    {
        int ucount=0;
